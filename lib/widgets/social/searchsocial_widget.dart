...
class SearchSocialWidget extends StatefulWidget {
  @override
  _SearchSocialWidgetState createState() => _SearchSocialWidgetState();
}

class _SearchSocialWidgetState extends State<SearchSocialWidget> {
  @override
