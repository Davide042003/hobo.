                ...
                Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text("Jayden Smith", style: TextStyle(
                            fontFamily: Constants.POPPINS,
                            fontSize: 15,
                            fontWeight: FontWeight.w600,
                            color: Styles.whiteblack(themeChange.darkTheme,
                                context)),),
                        Text("2d", style: TextStyle(
                            fontFamily: Constants.POPPINS,
                            fontSize: 12,
                            fontWeight: FontWeight.normal,
                            color: Color.fromRGBO(186, 195, 230, 1)),),
                      ],
                    ),
